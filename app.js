/* eunoia full editor app.js
   - SPA navigation
   - projects (create/open/delete)
   - centered Google-Docs style editor
   - toolbar with many formatting options
   - TOC (H1/H2/H3)
...
// storage keys
const PROJECTS_KEY = 'eunoia_projects_v3';
const PROJ_PREFIX = 'eunoia_proj_v3_';
...
// rename / delete (delete btn may not exist if old markup) - safe guard
