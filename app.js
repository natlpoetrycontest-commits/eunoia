...
window.addEventListener('click', (e)=> {
  // allow clicks on data-route elements created later
  const route = e.target.closest('[data-route]');
  if(route) showRoute(route.dataset.route);
});
...
// Delete project (if button added later)
...
// Reverie switching + functionality
